<%-- 
    Document   : beasiswa
    Created on : Dec 31, 2018, 12:39:58 PM
    Author     : Nesya
--%>
  ...
  <div class="site-wrap">
            ...
            <nav class="site-navigation text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="has-children">
                  <a href="category.jsp">Pilihan Perguruan Tinggi</a>
                  <ul class="dropdown">
    ...
    <div class="unit-5 overlay" style="background-image: url('images/hero_bg_2.jpg');">
      <div class="container text-center">
        <h2 class="mb-0">10 BEASISWA UNGGULAN MAHASISWA INTERNASIONAL</h2>
        <p class="mb-0 unit-6"><a href="index.jsp">Home</a> <span class="sep">></span> <span>Beasiswa</span></p>
      </div>
    </div>
...
<!--            <div class="p-5 bg-white">
          ...
          <p><a href="http://foreign.fulbrightonline.org">1. Fulbright Foreign Student Programme, Amerika</a></p>
            <p> Beasiswa Fulbright mengikat perjanjian dengan lebih dari 155 negara di dunia. Beasiswa ini menanggung biaya penuh – biaya kuliah, tiket penerbangan, buku pelajaran, asuransi kesehatan dan biaya hidup.
                Tujuan dari beasiswa ini adalah mendorong mahasiswa internasional untuk kuliah pascasarjana di Amerika, dan untuk membantu mereka mendapatkan kesempatan pendidikan dan budaya di tahun pertama perkuliahan dan seterusnya.
                Berhasil menjadi seorang Fulbrighter juga sudah pasti meningkatkan prospek karir mahasiswa internasional di masa depan. Mengapa? Karena proses seleksi Beasiswa Fulbright ini sangatlah ketat, dan hanya mahasiswa terbaik yang bisa mendapatkan beasiswa ini!
</p><p>
Cara mendaftar: Kunjungi situs resmi dan pilih negara asal kamu. Tanggungan beasiswa dan prosedur pendaftaran berbeda-beda untuk setiap negara. Biasanya, para pendaftar diminta untuk mengumpulkan personal statement, transkrip nilai pendidikan sebelumnya, ataupun nilai ujian bahasa Inggris. Beasiswa Fulbright ini sangat populer dan menarik banyak pendaftar. Walau demikian kamu tidak perlu terlalu pesimis, karena tersedia sekitar 4,000 beasiswa setiap tahun.</p>
              ...
              <p class="mt-5"><a href="index.jsp" class="btn btn-primary  py-2 px-4">Kembali</a></p>
            </div>
          </div>
        </div>
      </div>
